...
| ------------------------------- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `rest_api_init`                 | action | Registers the `/facets/get-settings` endpoint directly via `register_rest_route()`                                                                        |
...
| `query_vars`                    | filter | Registers `ep_sort__by_date` and `ep_filter_years` as allowed query vars                                                                                  |
...
**Fix**: Confirm `query_vars` is firing and that `ep_filter_years` is set in the URL. Enable debug mode to inspect `add_filters_to_query` output.
